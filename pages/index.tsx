...
export default function IndexPage() {
  ...
  useEffect(() => {
    recordSumStakeCount && setSumStakeCount(parseFloat(formatEther(recordSumStakeCount)))
    if (recordStakeCount) {
      setStakeCount(parseFloat(formatEther(recordStakeCount)))
      setRewardsCount(parseFloat(formatEther(recordStakeCount)) * 50)
    }
  }, [recordSumStakeCount, recordStakeCount]);
  return (
    <DefaultLayout>
      <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10 h-4/5">
        ...
        <div className="flex gap-3 h-2/3 w-2/5">
