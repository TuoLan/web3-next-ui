(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_f718c2._.js", {

"[project]/node_modules/proxy-compare/dist/index.modern.js [client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
"[project]/node_modules/valtio/esm/vanilla.mjs [client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/proxy-compare/dist/index.modern.js [client] (ecmascript)");
...
const buildProxyFunction = (objectIs = Object.is, newProxy = (target, handler)=>new Proxy(target, handler), canProxy = (x)=>isObject(x) && !refSet.has(x) && (Array.isArray(x) || !(Symbol.iterator in x)) && !(x instanceof WeakMap) && !(x instanceof WeakSet) && !(x instanceof Error) && !(x instanceof Number) && !(x instanceof Date) && !(x instanceof String) && !(x instanceof RegExp) && !(x instanceof ArrayBuffer), defaultHandlePromise = (promise)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$client$5d$__$28$ecmascript$29$__["markToTrack"])(snap, true);
    ...
    Reflect.ownKeys(target).forEach((key)=>{
        ...
        if (refSet.has(value)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$client$5d$__$28$ecmascript$29$__["markToTrack"])(value, false);
    ...
    const handler = {
        ...
        set (target, prop, value, receiver) {
            ...
            removePropListener(prop);
            if (isObject(value)) {
                value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$proxy$2d$compare$2f$dist$2f$index$2e$modern$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getUntracked"])(value) || value;
            }
            let nextValue = value;
...
"[project]/node_modules/@walletconnect/modal-core/dist/index.js [client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/valtio/esm/vanilla.mjs [client] (ecmascript)");
...
"__TURBOPACK__ecmascript__hoisting__location__";
;
const state$7 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["proxy"])({
    history: [
        "ConnectWallet"
    ],
    view: "ConnectWallet",
...
const RouterCtrl = {
    state: state$7,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["subscribe"])(state$7, ()=>callback(state$7));
    },
    push (view, data) {
...
const CoreUtil = {
    ...
    formatUniversalUrl (appUrl, wcUri, name) {
        ...
        if (safeAppUrl.startsWith("https://t.me")) {
            const formattedUri = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(wcUri).toString("base64").replace(/[=]/g, "");
            if (safeAppUrl.endsWith("/")) {
...
const state$6 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["proxy"])({
    enabled: isEnabled,
    userSessionId: "",
    events: [],
...
const EventsCtrl = {
    state: state$6,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["subscribe"])(state$6.events, ()=>callback((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["snapshot"])(state$6.events[state$6.events.length - 1])));
    },
    initialize () {
...
const state$5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["proxy"])({
    chains: void 0,
...
const OptionsCtrl = {
    state: state$5,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["subscribe"])(state$5, ()=>callback(state$5));
    },
    setChains (chains) {
...
const state$4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["proxy"])({
    projectId: "",
...
const ConfigCtrl = {
    state: state$4,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["subscribe"])(state$4, ()=>callback(state$4));
    },
    setConfig (config) {
        var _a, _b;
...
const state$3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["proxy"])({
    wallets: {
        listings: [],
        total: 0,
        page: 1
...
const state$2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["proxy"])({
    open: false
});
const ModalCtrl = {
    state: state$2,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["subscribe"])(state$2, ()=>callback(state$2));
    },
    async open (options) {
        return new Promise((resolve)=>{
...
const state$1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["proxy"])({
    themeMode: isDarkMode() ? "dark" : "light"
});
const ThemeCtrl = {
    state: state$1,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["subscribe"])(state$1, ()=>callback(state$1));
    },
...
const state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["proxy"])({
    open: false,
    message: "",
    variant: "success"
});
const ToastCtrl = {
    state,
    subscribe (callback) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$valtio$2f$esm$2f$vanilla$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["subscribe"])(state, ()=>callback(state));
    },
...
"[project]/node_modules/@walletconnect/modal/dist/index.js [client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
class WalletConnectModal {
    constructor(config){
        this.openModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ModalCtrl"].open;
        this.closeModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ModalCtrl"].close;
        this.subscribeModal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ModalCtrl"].subscribe;
        this.setTheme = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ThemeCtrl"].setThemeConfig;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ThemeCtrl"].setThemeConfig(config);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ConfigCtrl"].setConfig(config);
        this.initUi();
    }
    async initUi() {
        if (typeof window !== "undefined") {
            await __turbopack_require__("[project]/node_modules/@walletconnect/modal-ui/dist/index.js [client] (ecmascript, async loader)")(__turbopack_import__);
            const modal = document.createElement("wcm-modal");
            document.body.insertAdjacentElement("beforeend", modal);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$modal$2d$core$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["OptionsCtrl"].setIsUiLoaded(true);
        }
    }
}
;
...
//# sourceMappingURL=node_modules_f718c2._.js.map